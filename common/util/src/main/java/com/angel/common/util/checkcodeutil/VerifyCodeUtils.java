...
public class VerifyCodeUtils {
     ...
     * @throws IOException
     */
    public static String createVerifyCode(int codeSize,int width ,int heigth, OutputStream os) throws IOException {
        String code = generateVerifyCode(codeSize,VERIFY_CODES);
        BufferedImage image = dogetImage(width,heigth,code);
     ...
     * @return 图片
     */
    public static BufferedImage dogetImage(int w,int h,String code){
